package com.gfg.ds.graph.c7.connectivity;

import java.util.LinkedList;
import java.util.Queue;

public class Prob02_StringlyConnectedKosarajuDFS {
	...
	static class Graph {
		...
		private void performDFS(int u, boolean[] visited) {
			visited[u] = true;
			for (int eachAdjVertOfU : adj[u]) {
				if (visited[eachAdjVertOfU] == false) {
					performDFS(eachAdjVertOfU, visited);
				}
			}
		}
